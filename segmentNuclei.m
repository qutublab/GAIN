function [L N nucleusDataArr nominalMeanNucleusArea minNucleusArea] = segmentNuclei(I, parameters)
...
for i = numLabels:-1:1
    ...
    nucleusDataArr(i) = NucleusData(i, area, solidity, small, cluster);
end
